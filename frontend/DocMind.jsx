...
const BrainIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M9.5 2a2.5 2.5 0 0 1 5 0v1a2.5 2.5 0 0 1-5 0V2zM4 7a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v1a4 4 0 0 1-2 3.46V20a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-8.54A4 4 0 0 1 4 8V7z"/>
  </svg>
);
const UploadIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  const handleUpload = async (file) => {
    ...
    try {
      ...
      setMessages([{
        ...
        content: `✅ **${data.filename}** uploaded successfully!\n\nI've split it into **${data.num_chunks} chunks** and indexed them. Ask me anything about this document!`
      }]);
  ...
  const handleAsk = async () => {
    ...
    try {
      ...
      setMessages(m => m.map(msg => msg.id === typingId
        ? { ...msg, content: data.answer, chunks: data.context_chunks }
        : msg));
    } catch (e) {
      setMessages(m => m.map(msg => msg.id === typingId
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "32px 24px 48px" }}>
        ...
        <div style={{ background: "rgba(99,102,241,0.07)", border: "1px solid rgba(99,102,241,0.25)", borderRadius: 16, padding: 24, marginBottom: 28 }}>
          ...
          <p style={{ color: "#94a3b8", fontSize: 13, lineHeight: 1.8 }}>
            DocMind demonstrates how modern AI systems can combine information retrieval techniques with large language models to create powerful document-analysis tools. It can be applied in research, education, knowledge management, and document exploration — helping users quickly find answers within large documents.
          </p>
        </div>
        ...
        <div style={{ background: "linear-gradient(135deg,rgba(99,102,241,0.12),rgba(139,92,246,0.08))", border: "1px solid rgba(139,92,246,0.3)", borderRadius: 16, padding: 28 }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: 16 }}>
            <div style={{ width: 52, height: 52, borderRadius: "50%", background: "linear-gradient(135deg,#6366f1,#8b5cf6)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, flexShrink: 0 }}>S</div>
            <div style={{ flex: 1 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                {[
                  ...
                  <div key={label} style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    {href ? <a href={href} target="_blank" rel="noopener noreferrer" style={{ fontSize: 12, color: "#a5b4fc", textDecoration: "none" }}>{label}</a>
  ...
  return (
    <>
      ...
      <div style={{ height: "100vh", display: "flex", flexDirection: "column", background: "radial-gradient(ellipse at 20% 20%, rgba(99,102,241,0.12) 0%, transparent 60%), radial-gradient(ellipse at 80% 80%, rgba(139,92,246,0.08) 0%, transparent 60%), #080818" }}>
        ...
        {/* Header */}
        <header style={{ borderBottom: "1px solid rgba(99,102,241,0.2)", padding: "0 24px", flexShrink: 0, display: "flex", alignItems: "center", height: 58, backdropFilter: "blur(12px)", background: "rgba(8,8,24,0.8)", position: "relative", zIndex: 10 }}>
